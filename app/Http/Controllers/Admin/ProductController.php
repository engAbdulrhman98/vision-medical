...
class ProductController extends Controller
{
    ...
    public function store(StoreProductRequest $request)
    {
        ...
        if ($request->hasFile('image_file')) {
            $imagePath = \App\Services\CloudinaryService::upload($request->file('image_file'), 'products');
    ...
    public function update(UpdateProductRequest $request, Product $product)
    {
        ...
        if ($request->hasFile('image_file')) {
            if ($product->image) {
                if (str_contains($product->image, 'res.cloudinary.com')) {
                    \App\Services\CloudinaryService::delete($product->image);
                } elseif (str_contains($product->image, 'storage/products/')) {
